...
await db.set({ table: 'users', key: 'u1', email: 'admin@enhance.dev', firstname: 'Jane', lastname: 'Doe', roles: { role1: 'admin', role2: '', role3: '' } })
await db.set({ table: 'users', key: 'u2', email: 'member@enhance.dev', firstname: 'John', lastname: 'Smith', roles: { role1: 'member', role2: '', role3: '' } })
