...
async function main (){
  await db.set({ table: 'accounts', key: 'u1', email: 'admin@example.com', firstname: 'Jane', lastname: 'Doe', roles: { role1: 'admin', role2: 'member', role3: '' }, oauth: { github: { user: 'a-example' } } })
  await db.set({ table: 'accounts', key: 'u2', email: 'member@example.com', firstname: 'John', lastname: 'Smith', roles: { role1: 'member', role2: '', role3: '' }, oauth: { github: { user: 'm-example' } } })
